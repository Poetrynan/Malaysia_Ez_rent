...
| 文件 | 改动 |
|------|------|
| `Dashboard.tsx` | 重构图表为 Recharts，并修复 Responsive 崩溃、Hover 重渲染死循环，加 4 个指标的 Tooltip 说明。 |
