...
*文档更新：2026-05-26 · 含合租意向 RPC（014/015）、自行取消、缴租银行/微信/支付宝、禁止 iProperty、Memory vs Storage、Agent权限隔离与红点气泡通知、登录多语言与深色模式、房源列表多视图模式切换、中介主页与头像压缩(30KB)、去除社交引流外链、多中介独立挂牌、复制挂牌、编辑保存=覆盖同一条*