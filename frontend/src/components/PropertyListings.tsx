              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px 24px' }}>
                   {([
                      ...
                      {
                        label: t('detailCoords'),
                        val: selected.community ? `${selected.community.lat.toFixed(4)}, ${selected.community.lng.toFixed(4)}` : '—',
                        icon: <Globe size={15} style={{ color: 'var(--primary)', marginTop: 2, flexShrink: 0 }} />
                      },
