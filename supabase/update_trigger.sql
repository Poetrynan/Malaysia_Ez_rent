-- ========================================================================
-- UPDATE TRIGGER FOR USER REGISTRATION & AGENT PRE-APPROVAL NOTIFICATION
-- ========================================================================
-- Purpose: 
-- 1. Link auth.users registration to public.users.
-- 2. Link pre-approved admin/editor roles using email match.
-- 3. If an agent registration was approved BEFORE the user signed up/registered,
--    automatically insert the "Agent Application Approved" notification into 
--    user_notifications so that they see it in their inbox immediately on first login.
-- ========================================================================
